        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="flex gap-6 justify-center lg:justify-start mt-4">
              {socialLinks.map((link, index) => (
                <a
                  ...
                  className="text-gray-300 hover:text-purple-400 transition duration-300 transform hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(192,132,252,0.7)]"
                >
                  {link.icon}
                </a>
              ))}
          ...
          <div className="lg:w-1/2">
            <div className="relative w-64 h-64 md:w-80 md:h-80 mx-auto group">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full blur-2xl opacity-30 group-hover:opacity-50 transition duration-500"></div>
              <img
                src={Photo}
                alt="Anish Kumar"
                className="relative w-full h-full object-cover rounded-full shadow-2xl border-4 border-purple-400/30 transform transition duration-500 group-hover:scale-105 group-hover:shadow-purple-500/30"
              />
            </div>
          </div>
